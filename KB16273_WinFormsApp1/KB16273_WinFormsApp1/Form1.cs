...
namespace KB16273_WinFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        // 「20行目にスクロールする」ボタン クリック イベント ハンドラー
        private void button1_Click(object sender, EventArgs e)
        {
            int scrollToIndex = 19;
            ultraGrid1.DisplayLayout.RowScrollRegions[0].FirstRow = ultraGrid1.Rows[scrollToIndex];
            ultraGrid1.Rows[scrollToIndex].Activate();  // ※任意。もしアクティブ化もするのであれば。
        }
    }
}